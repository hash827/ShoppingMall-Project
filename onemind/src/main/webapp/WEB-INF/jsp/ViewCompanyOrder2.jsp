...
<div id="wrap">
	<div id="contents">
		<h2 style="margin-bottom: 26px">주문 확인</h2>
		...
		<table class="table">
			...
			<tr>
				<td colspan="2"><b><font color="green" size="4">주문 상태:</font>
						<c:out value="${companyOrder.status}" /></b></td>
			</tr>
			<tr>
				<td colspan="2">
                  ...
                  <c:param name="shoesId" value="${lineCompanyItem.shoesId}"/></c:url>'>
								...
								<td><c:out
										value="${shoes.shoesName}" /></td>
								<td><c:out
										value="${shoes.shoesColor}" /></td>
								<td><c:out
										value="${lineCompanyItem.shoesSize}" /></td>
